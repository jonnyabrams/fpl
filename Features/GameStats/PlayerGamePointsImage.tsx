  ...
  return (
    <View style={styles.container}>
      <View style={styles.imageContainer}>
        <Image
          style={styles.jersey}
          source={require("../../assets/jerseys/eve.png")}
          resizeMode="contain"
        />
        ...
        <View style={styles.allStatsContainer}>
          <View style={styles.statsContainer}>
            <Image
              ...
              source={require("../../assets/stats/goal.png")}
              resizeMode="contain"
            />
          </View>
          <View style={styles.statsContainer}>
            <Image
              style={styles.statsImage}
              source={require("../../assets/stats/assist.png")}
              resizeMode="contain"
            />
          </View>
          <View style={styles.cardsContainer}>
            <Image
              ...
              source={require("../../assets/stats/yellowcard.png")}
              resizeMode="contain"
            />
            <Image
              style={styles.cardImage}
              source={require("../../assets/stats/redcard.png")}
              resizeMode="contain"
            />
          </View>
        </View>
      ...
      <Text style={styles.text}>Gordon</Text>
    </View>
  );
};
